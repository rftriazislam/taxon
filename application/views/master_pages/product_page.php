                    ...
                    <div class="row margin-bottom-40">
                        ...
                        <div class="sidebar col-md-3 col-sm-5">
                            ...
                            <ul class="list-group margin-bottom-25 sidebar-menu">
                               ...
                               ?>
                                <li class="list-group-item  clearfix"><a href="<?php echo base_url()?>Welcome/product_page/<?php echo $v_category->category_id?>"><h4 class="btn" style="background-color:darkblue;color:white;"><?php echo $v_category->category_name?></h4></a></li>
                        ...
                        ?>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-item">
                                        ...
                                        <div class="pi-price"><?php echo $all_product->product_old_price?></div><br>
