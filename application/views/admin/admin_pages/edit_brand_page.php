<div class="row-fluid sortable " >
    ...
    <div class="box span12" >
        ...
        <div class="box-content ">
            ...
            <form class="form-horizontal " name="edit_banner" action="<?php echo base_url() ?>Super_Admin/update_banner" style="color:#980606" method="post" enctype="multipart/form-data">
