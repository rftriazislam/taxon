<div class="row-fluid sortable " >
    ...
    <div class="box span12" >
        ...
        <div class="box-content ">
            ...
            <form class="form-horizontal " action="<?php echo base_url() ?>Super_Admin/save_banner" style="color:#980606" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" >
                            <select id="selectError3" name="banner_type" style="color:#980606;">
                                <option style="color:#14de16;" >Select Banner Type</option>
