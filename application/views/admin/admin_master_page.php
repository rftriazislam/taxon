...
<html lang="en">
    <head>
        ...
        function categoryDelete(){
            var mes=confirm('Are You Sure To Remove !');
            if(mes){
                return true;
            }
            else{
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                                    ...
                                    $r = $this->session->userdata('admin_name');
                                    echo $r
                                    ?>
                    ...
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url() ?>Super_Admin"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
                             ...
                             <li>
                                 <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Manufacture</span> <span class="label label-important"> 2 </span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/add_manufacture"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Manufacture</span></a></li>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/manage_manufacture"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Manufacture</span></a></li>
                             ...
                             <li>
                                 <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Banner</span>   <span class="label label-important" > 2 </span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/add_banner"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Banner</span></a></li>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/manage_banner"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Banner</span></a></li>
                             ...
                             <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/add_brand"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Brand</span></a></li>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/manage_brand"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Brand</span></a></li>
                                    
                                </ul>	
                            </li>
                            
                            
                            <li><a href="<?php echo base_url() ?>Super_Admin/message_page"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <?php if ($breadcrumb) { ?>
                         <i class="icon-angle-right"></i>
                            <li><a href="<?php echo base_url() ?>Super_Admin/<?php echo $url_name ?>"><?php echo $page_name ?></a></li>
